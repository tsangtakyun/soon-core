...
export function IntelligenceInbox() {
  ...
  const visibleCapturedItems = selectedIndustry === 'all' ? capturedItems : capturedItems.filter((item) => item.industry_codes?.includes(selectedIndustry))
