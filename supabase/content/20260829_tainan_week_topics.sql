...
insert into public.topic_items (
  ...
  countries, regions, localities, languages, keywords, status
)
values
  ('tainan-6000-beef-soup-queue', '凌晨兩點半攞籌：台南六千牛肉湯排隊體驗', 'Instagram Reel 介紹台南六千牛肉湯。來源稱凌晨二時半可以排隊領取號碼牌，早上五時開始叫號，售完即止。', '', '來台南，可能真係唔應該瞓覺。', '["台南失眠美食路線","凌晨排隊到清晨開餐的體驗","台南牛肉湯早餐文化","第一鍋湯是否真的最值得排隊"]', array['short_video','carousel','story_series'], array['台灣'], array['台南'], array['海安路'], array['zh-HK'], array['台南牛肉湯','六千牛肉湯','台南早餐','凌晨美食','排隊美食','海安路','台南失眠行程','在地美食'], 'draft'),
  ('tainan-stadium-huage-beef-soup', '體育場樺哥土產牛肉湯：台南在地牛肉湯短影音題材', '現有 Instagram screenshot 顯示一間名為「體育場樺哥土產牛肉湯」的攤店，畫面以熱氣、煮食過程及牛肉展示為主。', '', '台南牛肉湯，未飲已經感受到成個畫面嘅熱氣。', '["台南牛肉湯的即點即煮畫面","台南在地早餐文化","體育場周邊美食探索","適合美食 Reel 的蒸氣與街頭感"]', array['short_video','carousel','single_image'], array['台灣'], array['台南'], array['台南體育場周邊'], array['zh-HK'], array['台南牛肉湯','樺哥牛肉湯','體育場美食','台南早餐','在地小吃','街頭美食','台南旅遊','美食短影音'], 'draft'),
  ('tainan-tobe-fresh-potato-chips', '赤崁樓旁即叫即炸：一整顆國產馬鈴薯製成的洋芋片', 'ToBe+兔彼炸物台南店位於赤崁樓附近。來源介紹整顆馬鈴薯即刨即炸的洋芋片，以及現點現炸雞翅。', '', '一整顆馬鈴薯，可以即場變成幾多塊洋芋片？', '["行完赤崁樓可以即買即食的小店","整顆馬鈴薯即刨即炸的製作過程","台南平價下午茶","赤崁樓周邊散步美食路線","現炸洋芋片與包裝薯片的口感比較"]', array['short_video','carousel','story_series'], array['台灣'], array['台南'], array['中西區','赤崁樓周邊'], array['zh-HK'], array['台南下午茶','赤崁樓美食','現炸洋芋片','ToBe兔彼炸物','台南中西區','台南小吃','散步美食','現炸雞翅'], 'draft'),
...
from (values
  ...
  ('tainan-stadium-huage-beef-soup','food',true,0.90), ('tainan-stadium-huage-beef-soup','travel-city',false,0.75),
